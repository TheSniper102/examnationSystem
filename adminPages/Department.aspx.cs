...
public partial class Department : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                txtbx.Text = "error " + exc.InnerException.Message;
            }
    ...
    protected void Dept_grd_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        obj = (ObjectDataSource)Session["obj1"];
        if (obj == null)
            txtbx.Text = "unable to get depratment records";
        else
        {
            ...
            DropDownList Manager = (DropDownList)Dept_grd.Rows[e.RowIndex].FindControl("DeptManager_ddl");
            ...
            obj.UpdateParameters.Add("Manager", Manager.SelectedValue.ToString());
    ...
    protected void saveDept_btn_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid == true)
        {
            ...
            else
            {
                ...
                obj.InsertParameters.Add("Manager", Manager.SelectedValue.ToString());
